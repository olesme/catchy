...
namespace AmbientMSTestTests
{
    ...
    /// </summary>
    [TestClass]
    public class CombinationTests : AmbientMSTestBase
    {
        /// <summary>
        ...
        public async Task Stateful_Soft_Returns_Same_Instance()
        {
            ...
            Assert.AreEqual(0, soft2.ErrorCount);  // Same state, no errors
        }
        ...
        public async Task Settings_Dont_Bleed_Between_Instances()
        {
            ...
            Assert.AreEqual(0, callbacksFired);  // No callbacks fired
        }
        ...
        public async Task Hard_Exceptions_Independent()
        {
            ...
            Assert.IsTrue(statelessThrew);
            Assert.IsTrue(statefulThrew);
        }
        ...
        public async Task Custom_Stateful_Soft_Accumulates_But_No_Auto_Flush()
        {
            ...
            Assert.AreEqual(2, customStateful.Soft.ErrorCount);
