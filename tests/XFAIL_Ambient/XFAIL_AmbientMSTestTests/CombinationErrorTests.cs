...
{
    /// <summary>
    /// Expected-to-fail tests for soft assertion combinations (MSTest version).
    ...
    /// - Use Assert.ThrowsException/Assert.ThrowsExceptionAsync for expected hard exceptions
    ...
    /// </summary>
    [TestClass]
    public class CombinationErrorTests : AmbientMSTestBase
    {
        /// <summary>
        ...
        public async Task XFAIL_SoftAccumulates_Multiple_Errors_FailsOnFlush()
        {
            ...
            Assert.AreEqual(3, Ambient.Assert.Soft.ErrorCount);
        ...
        public async Task XFAIL_Soft_Errors_Are_Instance_Specific()
        {
            ...
            Assert.AreEqual(1, Ambient.Assert.Soft.ErrorCount);
        ...
        /// Fails: Multiple accesses accumulate in same state
        /// </summary>
        [TestMethod]
