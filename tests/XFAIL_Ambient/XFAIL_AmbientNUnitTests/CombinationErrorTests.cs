...
{
    /// <summary>
    /// Expected-to-fail tests for soft assertion combinations (NUnit version).
    ...
    /// </summary>
    [TestFixture]
    public class CombinationErrorTests : AmbientNUnitBase
    {
        /// <summary>
        ...
        public async Task XFAIL_SoftAccumulates_Multiple_Errors_FailsOnFlush()
        {
            ...
            Assert.That(Ambient.Assert.Soft.ErrorCount, Is.EqualTo(3));
        ...
        public async Task XFAIL_Soft_Errors_Are_Instance_Specific()
        {
            ...
            Assert.That(Ambient.Assert.Soft.ErrorCount, Is.EqualTo(1));
