...
{
    /// <summary>
    /// Expected-to-fail tests for soft assertion combinations.
    ...
    /// </summary>
    public class CombinationErrorTests : CatchyTestBase
    {
        /// <summary>
        ...
        public async Task XFAIL_SoftAccumulates_Multiple_Errors_FailsOnFlush()
        {
            ...
            Assert.Equal(3, Ambient.Assert.Soft.ErrorCount);
        ...
        public async Task XFAIL_Soft_Errors_Are_Instance_Specific()
        {
            ...
            Assert.Equal(1, Ambient.Assert.Soft.ErrorCount);
